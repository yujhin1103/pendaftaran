...
<body>
    ...
    <main class="main-container">
        <div class="form-registration-container">
            ...
            <form action="/peserta/pendaftaran/proses" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="registration-grid">
                    ...
                    <div class="column-photo">
                        ...
                        <div class="photo-preview-box">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(session('username') ?? 'Yujhin') }}&background=f7f4eb&color=8c7643&size=250" alt="Preview Foto" id="photoPreview">
                        ...
                        <div class="photo-action-buttons">
                            ...
                            <input type="file" name="foto" id="foto" style="display: none;" onchange="previewImage(this)" accept="image/*">
    ...
    function removePreview() {
        document.getElementById('photoPreview').src = "https://ui-avatars.com/api/?name={{ urlencode(session('username') ?? 'Yujhin') }}&background=f7f4eb&color=8c7643&size=250";
        // PERBAIKAN JAVASCRIPT: Target id diubah ke 'foto' sesuai pasangannya
