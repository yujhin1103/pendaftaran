                ...
                <div class="registration-grid">
                    ...
                    <div class="column-photo">
                        ...
                        <div class="photo-action-buttons">
                            <label for="foto_formal" class="btn-action-photo btn-upload-file">
                                <i class="fa-solid fa-image"></i> Pilih / Ganti Foto
                            </label>
                            <input type="file" name="foto_formal" id="foto_formal" style="display: none;" onchange="previewImage(this)">
                    ...
                    <div class="column-fields">
                        ...
                        <div class="form-group-row">
                            ...
                            <textarea name="tempat_tinggal_sekarang" rows="2" placeholder="Tuliskan alamat domisili saat ini..." required></textarea>
                        </div>
